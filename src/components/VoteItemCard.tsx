        ...
        <div className="relative aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] overflow-hidden bg-black/20">
          ...
          <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6 lg:p-8 z-10">
            ...
            <div className="flex items-center gap-3 sm:gap-4 lg:gap-5">
              {/* Heart Count */}
              <div className="flex items-center gap-2 sm:gap-2.5 lg:gap-3 px-4 sm:px-5 lg:px-6 py-2.5 sm:py-3 lg:py-3.5 rounded-full bg-black/60 backdrop-blur-md border border-white/20">
                <Heart className={`w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 ${hasVoted ? "fill-[#FF00B3] text-[#FF00B3]" : "text-white/80"}`} />
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-3.5 rounded-full bg-white/90 backdrop-blur-md text-black font-semibold text-sm sm:text-base lg:text-lg hover:bg-white hover:scale-105 transition-all shadow-lg"
              >
